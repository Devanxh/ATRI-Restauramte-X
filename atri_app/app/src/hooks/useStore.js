...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox14": {
      "custom": {
        "text": "Lorem ipsum dolor sit amet consectetur adipiscing elit ugue quam diam vtae velit bibendum elementum eget non vivamus volutpat odio cras vestibulum purus aliqua"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image42": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616dc4908009251d2f5ac06b_egg-toast-restaurante-x-template-p-500%20(1).jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image49": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616da2c364b456b93fb50d6d_cta-restaurante-x-template%20(1).jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image54": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/star-svgrepo-com%20(1).svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image70": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616dbc58e6083f444f1883f5_blog-post-featured-image-05-restaurante-x-template-p-500%20(1).jpeg"
      },
      "callbacks": {
        "onClick": [
          {
